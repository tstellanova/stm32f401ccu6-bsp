...
#JLinkGDBServer  -device stm32f407vg --speed 1200 -if swd -AutoConnect 1 -port 2331
#JLinkGDBServer  -device stm32f407ve --speed 1200 -if swd -AutoConnect 1 -port 2331
